...
MAX_SOURCE_LEN=8000 # 25000 longer context contains more paper titles, but cost longer train time and larger memory usage
MAX_TARGET_LEN=16
DEV_BATCH_SIZE=1
...
torchrun --standalone --nnodes=1 --nproc_per_node=$NUM_GPUS  finetune2.py \
