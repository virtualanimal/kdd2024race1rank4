...
parser.add_argument('--lora_path', help='The path to the lora file',default="output/title_10000/checkpoint-2000")
...
parser.add_argument('--saved_dir',default='title_10000')
